...
[![Codemagic build status](https://api.codemagic.io/apps/634ae1a7816f0c9006d1cb1e/634ae1a7816f0c9006d1cb1d//status_badge.svg)](https://codemagic.io/apps/634ae1a7816f0c9006d1cb1e/634ae1a7816f0c9006d1cb1d//latest_build)
...
untuk menjalankan test coverage gunakan kode dibawah ini :

```
./genhtml.perl ./coverage/lcov.info -o coverage/html
```

hasil test bisa dilihat di path :
